        ...
        <div className="min-h-screen bg-slate-900">
            ...
            <header className="bg-slate-800 border-b border-slate-700 sticky top-0 z-10">
                <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-bold text-white">Child Support Calculator</span>
                    </div>
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <p className="mt-8 text-xs text-slate-500 text-center">
                    This calculator provides estimates based on {SITE.year} state guidelines.
                    Actual orders are determined by courts and may include additional factors.
                </p>
            </main>
