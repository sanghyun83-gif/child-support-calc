...
import { SITE, CALCULATORS, CHILD_SUPPORT_CONSTANTS_2025, formatCurrency } from "./site-config";
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-slate-400 text-center">
              For estimation purposes only. Consult your state guidelines or attorney for exact calculations.
            </p>
