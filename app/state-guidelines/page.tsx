...
import { SITE, STATE_DATA, formatCurrency, calculateChildSupport } from "../site-config";
        ...
        <div className="min-h-screen bg-slate-900">
            ...
            <header className="bg-slate-800 border-b border-slate-700 sticky top-0 z-10">
                <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-bold text-white">State Guidelines</span>
                    </div>
            ...
            <main className="max-w-4xl mx-auto px-4 py-8">
                ...
                <p className="mt-8 text-xs text-slate-500 text-center">
                    Guidelines shown are {SITE.year} approximations. Actual calculations vary
                    by case and may include additional factors. Consult official state resources.
                </p>
            </main>
        </div>
    );
